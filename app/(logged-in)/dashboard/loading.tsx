   ...
   return (
      <div className="flex gap-4 mb-8 justify-between">
         <div className="flex flex-col gap-2">
            ...
            >
               <Skeleton className="h-10 w-48  bg-rose-500/10" />
            </MotionH1>
            <MotionDiv
               variants={itemVariants}
               initial="hidden"
            ...
            >
               <Skeleton className="h-6 w-96 bg-rose-500/10" />
            </MotionDiv>
         </div>
         <MotionDiv
            variants={itemVariants}
         ...
         >
            <Skeleton className="h-10 w-32 bg-rose-500/10" />
         </MotionDiv>
      </div>
   );
}
...
function SummaryCardSkeleton() {
   return (
      ...
      >
         <Skeleton className="h-48 w-full rounded-lg bg-rose-500/10" />
      </MotionDiv>
   );
}
